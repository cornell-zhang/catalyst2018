...
### Extensions
In part 1B, you implement the sort distances function by applying the python built-in function called sort(). You may ask the question: what's going on? why it just worked? Actually there are many basic sorting algorithms, if you are interested, please go ahead and checkout this nice 6 minute video!
